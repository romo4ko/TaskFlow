...
function save() {
  axios.post('/api/users', form.value).then((response) => {
    ...
    <div>
        <div class="row">
          ...
          <div class="row row-cols-2 mb-2">
            ...
            <div class="col">
              <div class="form-group">
                ...
                <input v-model="form.extended" type="text" name="type" class="form-control mt-2" placeholder="Телефон"/>
              </div>
            </div>
          </div>
          ...
          <div class="row row-cols-2 mb-2">
            ...
            <div class="col">
              <div class="form-group">
                <strong class="mt-2">Пароль*:</strong>
